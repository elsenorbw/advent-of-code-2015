...
from day2_part2 import parse_dimension_string, calculate_ribbon_required
...
@pytest.mark.parametrize("test_input,expected", [((2, 3, 4), 34), ((1, 1, 10), 14)])
def test_calculate_ribbon_required(test_input, expected):
    actual = calculate_ribbon_required(*test_input)
    assert actual == expected
